...
<head>
	...
	<title>ATS Jobs - Job Portal</title>
...
<body class="home">
	...
	<div class="container-wrapper">
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								<a href="job-list.php">Job Openings</a>
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/img2.jpg');">
				<div class="container">

					<h1>Kick Start Your Journey Here!</h1>
					<p>Finding your next job or career on ATS Jobs</p>
		...
		">
			...
			<div class="bg-secondary pt-80 pb-80">
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">ATS</h5>
											<p> ATS Company is a prominent job portal dedicated to connecting job seekers with a diverse range of employment opportunities.ATS Company simplifies the job search process, making it easier for candidates to find their ideal career paths.</p>
									...
									<div class="col-sm-6 col-md-5 mt-30-xs">
										...
										<ul class="footer-menu clearfix">
											<li><a href="./">Home</a></li>
											<li><a href="job-list.php">Job Openings</a></li>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">ATS Jobs Contact</h5>
								
								<p>Address : Banglore,JP nagar 2nd phase</p>
								<p>Email : <a href="mailto:nightingale.nath2@gmail.com">karanthgowda15@gmail.com</a></p>
								<p>Phone : <a href="tel:+233546607474">+91 9986770284</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> ATS </p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<li><a >Developed by </a></li>
									<li><a>ADITYA THEJASHWINI SANJANA</a></li>
								</ul>
